...
\articletitle{Right to Refuse Treatment Vis-À-Vis Passive Euthanasia: Judicial Approach}\label{2019-art6}
\vspace{-.5cm}
...
consent, even though courts universally acknowledge patient's rights to refuse treatment, and
...
with other controversial medical treatments, the parent's and guardian's preferences may
...
authorized in India is the opposing side of a coin, yet it helps terminally ill patient’s
...
%~ Publisher's Name &: Alliance University,\\[-.2cm]
                 %~ &~  Bengaluru.\\
%~ Editors Namde &: Prof. (Dr.) Kiran Dennis\\[-.2cm]
              %~ &~ Gardner Associate Dean,\\[-.2cm]
